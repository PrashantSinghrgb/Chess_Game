...
namespace PrashantSingh.Utilities
{
	...
	{
		/// <summary> The initial size of the waitForSecondsDictionary. </summary>
		...
		private static Dictionary<float, WaitForSeconds> waitForSecondsDictionary = new Dictionary<float, WaitForSeconds>(INITIAL_SIZE, new FloatComparer());
